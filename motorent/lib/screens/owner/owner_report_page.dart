...
class _OwnerReportPageState extends State<OwnerReportPage> {
  ...
  final List<Map<String, dynamic>> _categories = [
    ...
    },
    {
      ...
      'description': 'Issues with booking management',
    },
    {
      'value': 'payment',
      'label': 'Payment Issue',
      'icon': Icons.payment,
      'description': 'Payment or revenue problems',
    },
    {
      'value': 'vehicle',
      'label': 'Vehicle Management',
      'icon': Icons.directions_car,
      'description': 'Vehicle listing or management issues',
    },
    {
      'value': 'driver',
      'label': 'Driver Issue',
      'icon': Icons.drive_eta,
      'description': 'Company driver management problems',
    },
    {
      'value': 'dashboard',
      'label': 'Dashboard Issue',
      'icon': Icons.dashboard,
      'description': 'Dashboard or analytics problems',
    },
    {
      'value': 'other',
      'label': 'Other',
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        await _firestore.collection('reports').add({
          ...
          'reporter_type': 'owner', // To distinguish from customer reports
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Help us improve MotoRent by reporting any issues you encounter as a car owner. Our team will review and respond promptly.',
                        style: TextStyle(
                          fontSize: 13,
                          color: Colors.blue[900],
                          height: 1.4,
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildTipItem('Mention which feature was affected'),
                  ],
                ),
              ),
              const SizedBox(height: 30),
