...
class _DriverReportPageState extends State<DriverReportPage> {
  ...
  final List<Map<String, dynamic>> _categories = [
    ...
    {
      'value': 'job',
      'label': 'Job/Ride Issue',
      'icon': Icons.work_outline,
      'description': 'Problems with ride assignments',
    },
    {
      'value': 'payment',
      'label': 'Payment Issue',
      'icon': Icons.payment,
      'description': 'Earnings or payout problems',
    },
    {
      'value': 'customer',
      'label': 'Customer Issue',
      'icon': Icons.person_outline,
      'description': 'Problems with customers',
    },
    {
      'value': 'vehicle',
      'label': 'Vehicle Issue',
      'icon': Icons.directions_car,
      'description': 'Issues with assigned vehicles',
    },
    {
      'value': 'schedule',
      'label': 'Schedule Issue',
      'icon': Icons.schedule,
      'description': 'Availability or scheduling problems',
    },
    {
      'value': 'safety',
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        await _firestore.collection('reports').add({
          ...
          'reporter_type': 'driver', // To distinguish from customer/owner reports
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Help us improve your driving experience on MotoRent. Report any issues or concerns you encounter while working.',
                        style: TextStyle(
                          fontSize: 13,
                          color: Colors.blue[900],
                          height: 1.4,
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildTipItem('Include job/ride ID if applicable'),
                    _buildTipItem('Describe what you were trying to do'),
                    _buildTipItem('Mention if this affects your safety'),
                  ],
                ),
              ),
              const SizedBox(height: 30),

              // Safety Notice for Critical Issues
              Container(
                padding: const EdgeInsets.all(16),
                decoration: BoxDecoration(
                  color: Colors.red[50],
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'For urgent safety concerns or emergencies, please contact support immediately at 1-800-MOTORENT.',
                        style: TextStyle(
                          fontSize: 12,
                          color: Colors.red[900],
                          height: 1.4,
